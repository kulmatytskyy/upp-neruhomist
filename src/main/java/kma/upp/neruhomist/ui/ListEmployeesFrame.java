...
@Component
public class ListEmployeesFrame extends DelayedInitJFrame {

    private javax.swing.JButton backButton;
    private javax.swing.JButton moreAboutWorkerButton;
    ...
    protected void initComponents() {
        ...
        moreAboutWorkerButton = new javax.swing.JButton();
        ...
        setTitle("Список співробітників");
        getContentPane().setLayout(null);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Список співробітників"));
        ...
        moreAboutWorkerButton.setText("Детальніше про співробітника...");
        moreAboutWorkerButton.setName("buttonOwnerDetails"); // NOI18N
        	...
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addGap(53)
        					.addComponent(moreAboutWorkerButton, GroupLayout.PREFERRED_SIZE, 201, GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGap(18)
        			.addComponent(moreAboutWorkerButton)
    ...
    private void attachActionsToButtons() {
        ...
        moreAboutWorkerButton.addActionListener(actionEvent -> {
            dispose();
